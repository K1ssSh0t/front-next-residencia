...
export type CategoriaPersonaResponse<Texpand = unknown> =
  Required<CategoriaPersonaRecord> & BaseSystemFields<Texpand>;
export type CuestionarioResponse<Texpand = unknown> =
  Required<CuestionarioRecord> & BaseSystemFields<Texpand>;
export type MediaSuperiorResponse<Texpand = unknown> =
  Required<MediaSuperiorRecord> & BaseSystemFields<Texpand>;
export type PreguntasResponse<Texpand = unknown> = Required<PreguntasRecord> &
  BaseSystemFields<Texpand>;
export type SuperiorResponse<Texpand = unknown> = Required<SuperiorRecord> &
  BaseSystemFields<Texpand>;
export type TipoBachillerResponse<Texpand = unknown> =
  Required<TipoBachillerRecord> & BaseSystemFields<Texpand>;
export type TipoInstitucionResponse<Texpand = unknown> =
  Required<TipoInstitucionRecord> & BaseSystemFields<Texpand>;
export type UsuarioResponse<Texpand = unknown> = Required<UsuarioRecord> &
...
export type TypedPocketBase = PocketBase & {
  collection(
    idOrName: "CategoriaPersona"
  ): RecordService<CategoriaPersonaResponse>;
  ...
  collection(
    idOrName: "TipoInstitucion"
  ): RecordService<TipoInstitucionResponse>;
